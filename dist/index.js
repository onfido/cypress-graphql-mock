...
var graphql_3 = require("./utils/graphql");
/**
...
Cypress.Commands.add("mockGraphql", function(options) {
  var _a = options.endpoint,
    ...
    _c = options.mocks,
    mocks = _c === void 0 ? {} : _c,
    _d = options.fetchSchema,
    fetchSchema = _d === void 0 ? false : _d;
  ...
  cy.on("window:before:load", function(win) {
    return tslib_1.__awaiter(_this, void 0, void 0, function() {
      ...
      var introspectionSchemaResult, _a, schema, originalFetch;
      return tslib_1.__generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            if (!fetchSchema) return [3 /*break*/, 2];
            return [4 /*yield*/, graphql_3.fetchGraphQLSchema(endpoint)];
          case 1:
            _a = _b.sent();
            return [3 /*break*/, 3];
          case 2:
...
function getRootValue(operations, operationName, variables) {
  ...
  if (Array.isArray(op)) {
    if (op.length > 0) {
      ...
      throw Error(
        'No more stub for the operation "' +
          operationName +
          '"! Check your stubs array for this operation.'
      );
    }
  }
  return op;
